...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyflex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14670&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyflex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyflex` can be installed with:

```
conda install ipyflex
```

It is possible to list all of the versions of `ipyflex` available on your platform with:
